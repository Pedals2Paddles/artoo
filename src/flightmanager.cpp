...
void FlightManager::onSoloMavlinkMsg(const mavlink_message_t * msg)
{
    ...
    case MAVLINK_MSG_ID_VFR_HUD:
        ...
        // No longer used for relative altitude sine VFR_HUD altitude changed
        // to MSL altitude in ArduCopter 3.6-RC6.  Relative altitude now
        // obtained from global_position_int.relative_alt
        break;
